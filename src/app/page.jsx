        ...
        <div>
                ...
                <div className={style.section2_slider}>
                    ...
                    >
                        ...
                        <SwiperSlide className={style.slider2_background}>
                            <Link href="#" target="_blank">
                                <div>
                                    <Image src="/homepage/ac.png" height={60} width={60} alt='img' />
                        ...
                        <SwiperSlide className={style.slider2_background}>
                            <Link href="#" target="_blank">
                                <div>
                                    <Image src="/homepage/invertor.png" height={60} width={60} alt='img' />
                        ...
                        <SwiperSlide className={style.slider2_background}>
                            <Link href="#" target="_blank">
                                <div>
                                    <Image src="/homepage/carpainter.png" height={60} width={60} alt='img' />
            ...
            <div className="container-fluid"> 
                ...
                <div className={`${style.section3_div2} col-xxl-6 col-xl-6 col-lg-4`}>
                    ...
                    <div>
                        <div>
                            <Link href="#">
                                <Image src="/homepage/fastservice.png" height={70} width={80} alt="img" />
                            </Link>
                            <span>Fast Service<br /> on Time</span>
                        </div>
                        <div>
                            <Link href="#">
                                <Image src="/homepage/helpcenter.png" height={70} width={70} alt="img" />
                            </Link>
                            <span>24/7 <br />Help Center</span>
                        </div>
                        <div>
                            <Link href="#">
                                <Image src="/homepage/widemap.png" height={70} width={70} alt="img" />
                            </Link>
                            <span>Wide<br /> Coverage Map</span>
                        </div>
                        <div>
                            <Link href="#">
                                <Image src="/homepage/employee.png" height={70} width={70} alt="img" />
                            </Link>
                            <span>More Than <br />1500 Employee</span>
                        </div>
                ...
                <div className={style.section4_div1}>
                    <div className={style.section4_div1_div1}>
                        <div>
                            ...
                            <div>
                                <Image src="/homepage/Layer_31.png" height={150} width={300} alt="img" />
                            </div>
                        </div>
                    </div>
                    <div className={style.section4_div1_div2}>
                        <div>
                            ...
                            <div>
                                ...
                                <div>
                                    <Image src="/homepage/Layer_35.png" height={150} width={400} alt="img" />
                                </div>
                            </div>
                        </div>
            ...
            <div className="container"> 
                ...
                <div className={style.section5_div2}>
                    ...
                    <div>
                        <div>
                            <div className={style.check_icon_div}><FiCheck /></div>
                            <div className={style.check_text_div}>
                                <h4 style={{ color: "#1d2022", fontWeight: "600" }}>#1 Quality Job</h4>
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                </p>
                            </div>
                        ...
                        <div>
                            <div className={style.check_icon_div}><FiCheck /></div>
                            <div className={style.check_text_div}>
                                <h4 style={{ color: "#1d2022", fontWeight: "600" }}>Top Companies</h4>
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                </p>
                            </div>
                        ...
                        <div>
                            <div className={style.check_icon_div}><FiCheck /></div>
                            <div className={style.check_text_div}>
                                <h4 style={{ color: "#1d2022", fontWeight: "600" }}>No Extra Charges</h4>
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                        ...
                        <div>
                            <div className={style.check_icon_div}><FiCheck /></div>
                            <div className={style.check_text_div}>
                                <h4 style={{ color: "#1d2022", fontWeight: "600" }}>24/7 Help Center</h4>
                                <p>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                                </p>
                            </div>
            ...
            <section className={style.section7}>
                ...
                <div className={style.section7_commentsection1}>
                    ...
                    <div className={style.section7_testmonial}>
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        <div>
                            <div> <Image src="/homepage/1.jpg" height={50} width={50} alt="img" /></div>
                            <div>
